        ...
        {quickActions.map((action) => {
          ...
          return (
            <button
              key={action.id}
              type="button"
              className="flex flex-col items-start gap-2.5 rounded-xl border border-line dark:border-[#293227] dark:bg-[#152019] p-4 text-left hover:border-leaf-500/40 hover:shadow-sm transition-all"
            >
